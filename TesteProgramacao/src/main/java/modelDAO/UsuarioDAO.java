...
public class UsuarioDAO {
     ...
     */
    public Usuario selectPorUsuarioESenha(Usuario usuario){
        for (Usuario usuarioLista : Banco.usuario) {
            if(usuarioESenhaSaoIguais(usuarioLista,usuario)){
                return usuarioLista;
            }
        }
        return null;
     ...
     */
    private boolean usuarioESenhaSaoIguais(Usuario usuario, Usuario usuarioAPesquisar) {
